...
function App() {
  ...
  const getText = () => {
  axios.get(`https://api.giphy.com/v1/gifs/search?api_key=${process.env.REACT_APP_GIPHY_KEY}&q=${searchValue}&limit=12`)
        .then(response => {
  ...
  const handleSearchInputChanges = (e) => {  
    ...
    return (
      ...
      <div className="App">
        ...
        <button className="bg-warning" onClick={getText}> search </button>
